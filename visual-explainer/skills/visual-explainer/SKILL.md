...
description: This skill should be used when the user asks to "create a diagram", "generate a visualization", "make an architecture overview", "build a visual plan", "review this diff visually", "generate slides", "recap this project", or asks for any visual HTML explanation of technical concepts. Also activates proactively when about to render a complex ASCII table (4+ rows or 3+ columns) — presents it as a styled HTML page instead. Produces self-contained HTML with Mermaid diagrams, CSS Grid layouts, Chart.js dashboards, and anti-AI-slop aesthetics.
version: 0.4.4
---
