...
Write to `~/Desktop/Visual Explainer Pages/` with a descriptive filename (e.g., `feature-name-plan.html`). Open the result in the browser. Tell the user the file path.
